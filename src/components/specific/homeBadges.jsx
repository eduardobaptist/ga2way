  ...
  const badges = [
    {
      ...
      content: "O gat2way impulsiona a inovação, gerando soluções tecnológicas para os desafios da sociedade. A colaboração entre empresas e instituições fomenta o desenvolvimento de talentos e a criação de um ecossistema de inovação vibrante.",
      icon: Users
    },
    {
      title: "Para empresas",
      content: "Conecte-se com talentos e projetos inovadores, agilize o desenvolvimento de novos produtos e serviços, e fortaleça sua marca como uma empresa comprometida com a inovação.",
      icon: Building2
    },
    {
      title: "Para instituições",
      content: "Ofereça aos seus alunos a oportunidade de aplicar seus conhecimentos em projetos reais, promovendo a pesquisa e o desenvolvimento tecnológico e fortalecendo a relação entre academia e mercado.",
      icon: GraduationCap
    }
  ];
