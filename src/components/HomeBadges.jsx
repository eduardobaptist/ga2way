  ...
  const badges = [
    {
      ...
      content:
        "O gat2way impulsiona a inovação, gerando soluções tecnológicas para os desafios da sociedade. A colaboração entre empresas e instituições fomenta o desenvolvimento de talentos e a criação de um ecossistema de inovação vibrante.",
      icon: Users,
    },
    {
      title: "Para empresas",
